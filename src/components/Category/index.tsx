...
const Category: React.FC<CategoriesType> = ({
  ...
  return (
    <div className="bg-slate-400 bg-opacity-80 h-[30rem] rounded-md flex p-4">
    <div className={`flex-1 bg-${image} bg-center bg-contain bg-no-repeat`}></div>
    <div className="flex-1 flex flex-col gap-4 items-center">
      <span className='text-4xl text-center'> {id} </span>
